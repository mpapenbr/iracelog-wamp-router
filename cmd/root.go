...
var rootCmd = &cobra.Command{
	Use:     "iwr",
	Short:   "WAMP Message router for iRacelog",
	Long:    ``,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "",
		"config file (default is $HOME/.iwr.yml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".iwr" (without extension).
		viper.AddConfigPath(home)
		viper.AddConfigPath(".")
		viper.SetConfigType("yaml")
		viper.SetConfigName(".iwr")
	}
